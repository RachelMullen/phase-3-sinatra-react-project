...
Hunt.create(title: "Da spots fo da Homies, naw mean?", user_id: User.find_by(username: "DaddyCham").id, public: true)
Hunt.create(title: "Da spots fo da Ladies, naw mean?", user_id: User.find_by(username: "DaddyCham").id, public: true)
...
Hunt.create(title: "Dive Bars", user_id: User.find_by(username: "Mullet").id, public: true)
Hunt.create(title: "Nerd Stuff", user_id: User.find_by(username: "Mullet").id, public: true)
...
Hunt.create(title: "Art Circles and Vibes", user_id: User.find_by(username: "Cass").id, public: true)
...
Hunt.create(title: "Tokyo for Big Sister", user_id: User.find_by(username: "bigsis").id, public: true)
...
Comment.create(body: "I saw Friction here for the first time before I knew I would be a dnb artist.", user_id: User.find_by(username: "bigsis").id, place_id: Place.find_by(name: "WOMB").id)
